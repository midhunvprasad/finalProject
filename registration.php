...
<?php require_once('header.php'); ?>
        <body id="home2" class="user-register blog">
...
?>
    ...
    <div class="container">
        <div class="row">
                    ...
                    <form action="" method="post">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                          <label for="inputEmail4"><?php echo LANG_VALUE_102; ?></label>
                           <input type="text" class="form-control" name="cust_name" value="<?php if(isset($_POST['cust_name'])){echo $_POST['cust_name'];} ?>">
                        </div>
                        <div class="form-group col-md-6">
                          <label for="inputPassword4"><?php echo LANG_VALUE_103; ?></label>
            ...
            <div class="col-md-6">
                <br>
                <img src="assets/img/other/1.jpg" style="width: 600px;">
            </div>
        </div>
    </div>
</div>
